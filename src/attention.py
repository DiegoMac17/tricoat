### Multi-head attention implementation from https://github.com/mahmoodlab/MCAT ### 
...
from released.model_utils import *
...
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False, kdim=None, vdim=None):
        ...
        self.out_proj = NonDynamicallyQuantizableLinear(embed_dim, embed_dim) #DMR Update to new Ptyorch
